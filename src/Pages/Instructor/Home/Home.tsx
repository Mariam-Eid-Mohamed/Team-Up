...
// export function InstructorDashboard({ onSelectClass }: InstructorDashboardProps) {
...
//       case 'course-plans': return 'Course Plans';
...
//                       <span className="text-2xl text-[#9B87F5]">{classes.length}</span>
//                     </div>
//                     <div>
...
//                       <span className="text-2xl text-[#0F766E]">{classes.reduce((acc, c) => acc + c.studentsCount, 0)}</span>
//                     </div>
//                     <div>
...
//                       <span className="text-2xl text-[#10B981]">{classes.reduce((acc, c) => acc + c.teamsCount, 0)}</span>
//                     </div>
//                     <div>
...
//               <h2 className="text-[#171717]">My Classes</h2>
//               <span className="text-sm text-[#A3A3A3]">{classes.length} active classes</span>
//             </div>
...
//                 <p className="text-[#A3A3A3] mb-4">No classes yet. Create your first class to get started!</p>
//                 <button
...
//         return (
//           <div>
//             <h2 className="text-[#171717] mb-6">All Teams</h2>
//             <div className="bg-white rounded-lg border border-[#E5E5E5] p-8 text-center">
//               <p className="text-[#A3A3A3]">Teams view - Coming soon</p>
//             </div>
//           </div>
//         );
...
//         return (
//           <div>
//             <h2 className="text-[#171717] mb-6">All Students</h2>
//             <div className="bg-white rounded-lg border border-[#E5E5E5] p-8 text-center">
//               <p className="text-[#A3A3A3]">Students view - Coming soon</p>
//             </div>
//           </div>
//         );
...
//         return (
//           <div>
//             <h2 className="text-[#171717] mb-6">Announcements</h2>
//             <div className="bg-white rounded-lg border border-[#E5E5E5] p-8 text-center">
//               <p className="text-[#A3A3A3]">Announcements view - Coming soon</p>
//             </div>
//           </div>
//         );
...
//         return (
//           <div>
//             <h2 className="text-[#171717] mb-6">Course Plans</h2>
//             <div className="bg-white rounded-lg border border-[#E5E5E5] p-8 text-center">
//               <p className="text-[#A3A3A3]">Course plans view - Coming soon</p>
//             </div>
//           </div>
//         );
...
//         return (
//           <div>
//             <h2 className="text-[#171717] mb-6">Settings</h2>
//             <div className="bg-white rounded-lg border border-[#E5E5E5] p-8 text-center">
//               <p className="text-[#A3A3A3]">Settings view - Coming soon</p>
//             </div>
//           </div>
//         );
