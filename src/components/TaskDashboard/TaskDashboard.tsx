      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="relative flex-1 max-w-xl">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all shadow-xs"
          />
        </div>
